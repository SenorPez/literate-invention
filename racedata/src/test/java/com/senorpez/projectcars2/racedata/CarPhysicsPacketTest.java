...
public class CarPhysicsPacketTest {
    ...
    @Test
    public void getCarFlags() throws Exception {
        final CarPhysicsPacketBuilder builder = new CarPhysicsPacketBuilder();
        packet = new CarPhysicsPacket(builder.build());
        assertThat(packet.getCarFlags(), is(builder.getExpectedCarFlags()));
    }

    @Test
    public void getCarFlags_MaxValue() throws Exception {
        final CarPhysicsPacketBuilder builder = new CarPhysicsPacketBuilder()
                .setExpectedCarFlags(MAX_UNSIGNED_BYTE);
        packet = new CarPhysicsPacket(builder.build());
        assertThat(packet.getCarFlags(), is(MAX_UNSIGNED_BYTE));

        builder.setExpectedCarFlags((byte) (MAX_UNSIGNED_BYTE + 1));
        packet = new CarPhysicsPacket(builder.build());
        assertThat(packet.getCarFlags(), is(not(MAX_UNSIGNED_BYTE + 1)));
    }

    @Test
    public void getCarFlags_Min_Value() throws Exception {
        final CarPhysicsPacketBuilder builder = new CarPhysicsPacketBuilder()
                .setExpectedCarFlags(MIN_UNSIGNED_BYTE);
        packet = new CarPhysicsPacket(builder.build());
        assertThat(packet.getCarFlags(), is(MIN_UNSIGNED_BYTE));

        builder.setExpectedCarFlags((byte) (MIN_UNSIGNED_BYTE - 1));
        packet = new CarPhysicsPacket(builder.build());
        assertThat(packet.getCarFlags(), is(not(MIN_UNSIGNED_BYTE - 1)));
    }
