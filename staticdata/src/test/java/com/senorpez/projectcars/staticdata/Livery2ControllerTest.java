...
@SpringBootTest
public class Livery2ControllerTest {
    private MockMvc mockMvc;
    private static final MediaType INVALID_MEDIA_TYPE = new MediaType("application", "invalid", UTF_8);
    private static final ClassLoader CLASS_LOADER = Livery2ControllerTest.class.getClassLoader();
    ...
    public void setUp() throws Exception {
        ...
        this.mockMvc = MockMvcBuilders
                .standaloneSetup(new LiveryController(apiService, null, Collections.singletonList(FIRST_CAR)))
    ...
    public void getAllLiveries_ValidCarId_ValidAcceptHeader() throws Exception {
        ...
        mockMvc.perform(get(String.format("/cars/%d/liveries", FIRST_CAR.getId())).accept(PROJECT_CARS_2))
                ...
                .andExpect(jsonPath("$._links.self", hasEntry("href", String.format("http://localhost:8080/cars/%d/liveries", FIRST_CAR.getId()))))
                .andExpect(jsonPath("$._links.curies", everyItem(
                        allOf(
                                hasEntry("href", (Object) "http://localhost:8080/docs/{rel}"),
                                hasEntry("name", (Object) "pcars"),
                                hasEntry("templated", (Object) true)))))
                .andDo(document("liveries2",
                        ...
                        responseFields(
                                fieldWithPath("_embedded.pcars:livery").description("Livery resources"),
                                fieldWithPath("_embedded.pcars:livery[].id").description("ID number"),
                                fieldWithPath("_embedded.pcars:livery[].name").description("Name"),
                                subsectionWithPath("_links").ignored(),
                                subsectionWithPath("_embedded.pcars:livery[]._links").ignored()),
                        commonLinks.and(
                                linkWithRel("pcars:car").description("Car resource"))));
    ...
    public void getAllLiveries_ValidId_InvalidMethod() throws Exception {
        ...
        mockMvc.perform(put(String.format("/cars/%d/liveries", FIRST_CAR.getId())).accept(PROJECT_CARS_2))
    ...
    public void getAllLiveries_InvalidCarId_ValidAcceptHeader() throws Exception {
        ...
        mockMvc.perform(get("/cars/8675309/liveries").accept(PROJECT_CARS_2))
    ...
    public void getAllLiveries_InvalidCarId_InvalidMethod() throws Exception {
        ...
        mockMvc.perform(put("/cars/8675309/liveries").accept(PROJECT_CARS_2))
                .andExpect(status().isMethodNotAllowed())
                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                .andExpect(content().string(matchesJsonSchema(ERROR_SCHEMA)))
                .andExpect(jsonPath("$.code", is(METHOD_NOT_ALLOWED.value())))
    ...
    public void getSingleLivery_ValidCarId_ValidLiveryId_ValidAcceptHeader() throws Exception {
        ...
        mockMvc.perform(get(String.format("/cars/%d/liveries/%d", FIRST_CAR.getId(), FIRST_LIVERY.getId())).accept(PROJECT_CARS_2))
                .andExpect(status().isOk())
                .andExpect(content().contentType(PROJECT_CARS_2))
                ...
                .andExpect(jsonPath("$._links.index", hasEntry("href", "http://localhost:8080/")))
                .andExpect(jsonPath("$._links.self", hasEntry("href", String.format("http://localhost:8080/cars/%d/liveries/%d", FIRST_CAR.getId(), FIRST_LIVERY.getId()))))
                .andExpect(jsonPath("$._links.curies", everyItem(
                        allOf(
                                hasEntry("href", (Object) "http://localhost:8080/docs/{rel}"),
                                hasEntry("name", (Object) "pcars"),
                ...
                .andDo(document("livery2",
                        ...
                        responseFields(
                                ...
                                subsectionWithPath("_links").ignored()),
                        commonLinks.and(
                                linkWithRel("pcars:liveries").description("List of event resources."))));
    ...
    public void getSingleLivery_ValidCarId_ValidLiveryId_InvalidMethod() throws Exception {
        ...
        mockMvc.perform(put(String.format("/cars/%d/liveries/%d", FIRST_CAR.getId(), FIRST_LIVERY.getId())).accept(PROJECT_CARS_2))
                .andExpect(status().isMethodNotAllowed())
                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                .andExpect(content().string(matchesJsonSchema(ERROR_SCHEMA)))
                .andExpect(jsonPath("$.code", is(METHOD_NOT_ALLOWED.value())))
    ...
    public void getSingleLivery_ValidCarId_InvalidLiveryId_ValidAcceptHeader() throws Exception {
        ...
        mockMvc.perform(get(String.format("/cars/%d/liveries/86753029", FIRST_CAR.getId())).accept(PROJECT_CARS_2))
                .andExpect(status().isNotFound())
                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                .andExpect(content().string(matchesJsonSchema(ERROR_SCHEMA)))
                .andExpect(jsonPath("$.code", is(NOT_FOUND.value())))
    ...
    public void getSingleLivery_ValidCarId_InvalidLiveryId_InvalidMethod() throws Exception {
        ...
        mockMvc.perform(put(String.format("/cars/%d/liveries/8675309", FIRST_CAR.getId())).accept(PROJECT_CARS_2))
                .andExpect(status().isMethodNotAllowed())
                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                .andExpect(content().string(matchesJsonSchema(ERROR_SCHEMA)))
                .andExpect(jsonPath("$.code", is(METHOD_NOT_ALLOWED.value())))
    ...
    public void getSingleLivery_InvalidCarId_XXXLiveryId_ValidAcceptHeader() throws Exception {
        ...
        mockMvc.perform(get(String.format("/cars/8675309/liveries/%d", FIRST_LIVERY.getId())).accept(PROJECT_CARS_2))
                .andExpect(status().isNotFound())
                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                .andExpect(content().string(matchesJsonSchema(ERROR_SCHEMA)))
                .andExpect(jsonPath("$.code", is(NOT_FOUND.value())))
    ...
    public void getSingleLivery_InvalidCarId_XXXLiveryId_InvalidMethod() throws Exception {
        ...
        mockMvc.perform(put(String.format("/cars/8675309/liveries/%d", FIRST_LIVERY.getId())).accept(PROJECT_CARS_2))
                .andExpect(status().isMethodNotAllowed())
                .andExpect(content().contentType(APPLICATION_JSON_UTF8))
                .andExpect(content().string(matchesJsonSchema(ERROR_SCHEMA)))
                .andExpect(jsonPath("$.code", is(METHOD_NOT_ALLOWED.value())))
