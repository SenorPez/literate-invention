...
class SupportedMediaTypes {
    ...
    static final MediaType PROJECT_CARS_2 = new MediaType("application", "vnd.senorpez.pcars2.v0+json", UTF_8);
    static final String PROJECT_CARS_2_VALUE = "application/vnd.senorpez.pcars2.v0+json; charset=UTF-8";
