...
//        final APIResourceAssembler<M, R> assembler = makeAssembler(supplier, controllerClass, resourceClass);
//        return assembler.toResource(model, parameters);
//    }
//
//    default <C> APIResourceAssembler<M, R> makeAssembler(final Supplier<R> supplier, final Class<C> controllerClass, final Class<R> resourceClass) {
//        return new APIResourceAssembler<>(
//                controllerClass,
//                resourceClass,
//                supplier);
//    }
